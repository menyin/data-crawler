package com.cs.wujiuqi.data.crawler.wuba;
...
import com.cs.wujiuqi.data.crawler.zhilian.ZhilianJobListUpIterator;
 ...
 */
public class ZhilianJobListUpIteratorBack1 implements StoppableIterator<String> {
    /*模拟部分条件数据数据*/
    ...
    static {
        ...
        CONDITIONS.put("pageIndex", Arrays.asList(new String[]{"2", "3", "4"}));//月薪
    ...
    public ZhilianJobListUpIteratorBack1() {
        conditionCarteinsIterator=CONDITION_CARTEINS.iterator();
    }
    public ZhilianJobListUpIteratorBack1(int limit) {
        this.limit = limit;
    }
