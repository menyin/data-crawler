...
//                         HttpGet httpGet = new HttpGet("https://capi.zhaopin.com/capi/position/detail?number="+jobs[ii]);
                         HttpGet httpGet = ii%2==0? new HttpGet("https://capi.zhaopin.com/capi/position/detail?number="+jobs[ii]):new HttpGet("https://capi.zhaopin.com/capi/position/search?component=true");
//                         HttpGet httpGet = new HttpGet("https://wxapp.58.com/list/detail?infoId=40706289135389");//58的职位
